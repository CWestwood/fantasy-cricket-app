-- Fix the check_team_composition trigger to properly handle substitutions
-- When inserting a new player, only count currently active (non-substituted) players
